...
exports.operatorInfos = (_j = {},
    ...
    _j[types_1.OperatorCode.StringParseJsonBoolean] = {
        type: types_1.Type.String,
        name: 'parseJson_boolean',
        arguments: [],
        outputType: types_1.OutputType.Boolean,
    },
    _j[types_1.OperatorCode.StringParseJsonInteger] = {
        type: types_1.Type.String,
        name: 'parseJson_integer',
        arguments: [],
        outputType: types_1.OutputType.Integer,
    },
    _j[types_1.OperatorCode.StringParseJsonFloat] = {
        type: types_1.Type.String,
    ...
    _j[types_1.OperatorCode.StringParseJsonString] = {
        type: types_1.Type.String,
