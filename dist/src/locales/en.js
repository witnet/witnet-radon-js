...
exports.en = void 0;
exports.en = {
    operator_info_description_array_count: 'Count the number of elements in the input Array',
    ...
    aggregation_tally_reducer_description_mode: 'Compute the mode of the values',
    aggregation_tally_reducer_description_averagemean: 'Compute the average mean of the values',
    aggregation_tally_reducer_description_deviationstandard: 'Compute the standard deviation of the values',
};
