import { ArgumentInfo, MarkupInputType, MirArgumentType, MarkupArgumentType, MirOperator, OperatorCode, MirArgument, OutputType, Type } from './types';
...
export declare function formatJs(source: string): string;
