...
export enum OperatorCode {
  ...
  StringParseJsonBoolean = 0x76,
  StringParseJsonInteger = 0x77,
  StringParseJsonFloat = 0x78,
  StringParseJsonMap = 0x79,
  StringParseJsonString = 0x7a,
  StringParseXML = 0x7b,
  StringToLowerCase = 0x7c,
  StringToUpperCase = 0x7d,
}
